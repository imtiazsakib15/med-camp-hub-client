      ...
      <div className="flex items-center flex-col-reverse lg:flex-row gap-10 my-14 md:my-20 overflow-hidden">
        ...
        <div className="lg:w-1/2 space-y-3" data-aos="fade-left">
          ...
          <p>
            ...
            trusted source for information about medical camps and
            health-related events. Our mission is to bridge the gap between
            healthcare providers and the communities they serve, making it
            easier for individuals to access vital medical services.
          </p>
